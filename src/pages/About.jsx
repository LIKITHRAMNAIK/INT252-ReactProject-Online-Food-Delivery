    ...
    <div className='about-page'>
      ...
      <div className='container my-5'>
        <p className='about-text'>
          Welcome to GOODFOOD, where culinary creativity meets warm hospitality. Nestled in the heart of Hyderabad, we’re a cozy, inviting spot that combines the finest ingredients with expert techniques to bring you an exceptional dining experience.
